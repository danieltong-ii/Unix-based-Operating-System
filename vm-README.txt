...
Anjali Bhagat anjalib@usc.edu
Rajnandini Thopte thopte@usc.edu 
Gautami Langarkande langarka@usc.edu
Daniel Tong tongd@usc.edu 
...
+--------------------------------------------------------------------------------------------+
Please test our code for extra credit with updating the Config.mk file with DYNAMIC=1.
please run /usr/bin/stress first and then run /usr/bin/stress limit250 or stress limit250. Otherwise the code will crash.
Do not run stress limit250 or /usr/bin/stress limit250 when you restart the weenix
+-----------------------------------------------+
